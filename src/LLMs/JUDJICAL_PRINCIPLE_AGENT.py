...
def get_judjical_principle_model():
    cfg = get_settings()
    model = cfg.JUDJICAL_PRINCIPLE_AGENT
    temp = cfg.JUDJICAL_PRINCIPLE_TEMP
    llm = JudjicalPrincipleModel(model, temp)
