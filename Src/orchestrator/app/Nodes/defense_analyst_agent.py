...
from app.Prompts.defense_analysis_agent import DEFENSE_ANALYSIS_AGENT_PROMPT
...
"""
        try:
            ...
            self.log("✅ DefenseAnalyst done")
        except Exception as e:
            self.log(f"⚠️ LLM failed ({e}), building structured fallback", "warning")
            # Structured fallback — built from actual state data, NOT hardcoded
